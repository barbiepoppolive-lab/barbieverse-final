...
export const Route = createFileRoute("/join/wobb")({
  ...
  component: WobbJoinPage,
});

function WobbJoinPage() {
    ...
    <SiteLayout>
      <section className="container mx-auto px-4 py-10 sm:py-16">
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-purple-400/40 bg-purple-500/10 px-3 py-1 text-xs font-semibold text-purple-400">
            <Sparkles className="h-3.5 w-3.5" /> Welcome from Wobb
          </div>
          <h1 className="mt-4 font-display text-3xl font-bold sm:text-4xl lg:text-5xl">
            You Found Us on <span className="text-gradient-pink">Wobb</span>
          </h1>
          <p className="mt-3 text-muted-foreground">
            Start earning ₹1,150+ this week. Takes less than 2 minutes.
          </p>
        </div>
        ...
        <div className="mx-auto mt-8 max-w-lg text-center">
          <div className="rounded-2xl border border-border/60 bg-card/40 p-6 backdrop-blur-md">
            ...
            <a
              href={`https://wa.me/${adminWhatsapp.replace(/[^0-9]/g, "")}?text=${encodeURIComponent("Hi! I found you on Wobb and want to join Barbieverse agency. Can you help me?")}`}
              target="_blank"
