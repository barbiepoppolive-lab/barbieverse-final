...
// Seed-per-topic + gender-aware persona logic now lives in
// @/lib/ai/image-persona.ts (shared with social-publish/index.ts's carousel
// generation and the ad-creative generator) — see that file for why this
// replaced a fixed seed + hardcoded-female persona.
