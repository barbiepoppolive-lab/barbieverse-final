...
const meta = POLICY_META.policy_creator_reward;

export const Route = createFileRoute("/creator-reward-policy")({
  head: () => ({
    meta: [
...
function Page() {
  ...
  const content = data.policy_creator_reward || DEFAULT_POLICY_CONTENT.policy_creator_reward;
  return (
    <PolicyShell
