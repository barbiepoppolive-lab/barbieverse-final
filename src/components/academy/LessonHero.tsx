      ...
      <div className="container relative mx-auto px-4 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
            <span className="inline-flex items-center gap-1 rounded-full border border-border/40 bg-card/30 px-3 py-1">
              <BookOpen className="h-3 w-3" /> Lesson {lessonNumber} of 20
            </span>
